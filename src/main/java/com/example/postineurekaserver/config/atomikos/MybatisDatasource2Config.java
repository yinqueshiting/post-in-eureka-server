...
@MapperScan(basePackages = "com.example.postineurekaserver.mapper.cluster", sqlSessionFactoryRef = "sqlSessionFactory2")
public class MybatisDatasource2Config {
    ...
    public SqlSessionFactory sqlSessionFactory2() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:mapper/cluster/*.xml"));
